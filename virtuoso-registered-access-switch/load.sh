...
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant/v3 '*.nt.gz' 'http://togovar.biosciencedbc.jp/variation'

#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3/ 'HGVD.*.nt.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/hgvd'
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3/ 'JGA-SNP.*.nt.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/jga_ngs'
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3/ 'JGA-NGS.*.nt.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/jga_snp'
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3 '4.7K.*.nt.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/tommo_4.7kjpn'
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3 '10K.*.nt.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/gem_j_wga'
#add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/variant_frequency/v3 'ExAC.*.ttl.gz' 'http://togovar.biosciencedbc.jp/variation/frequency/exac'

add_load_list ${LOAD_DATA_BASE}/virtuoso-registered-access/ddbjaccount/ '*.ttl' 'http://togovar.biosciencedbc.jp/registered_access/ddbjaccount'
