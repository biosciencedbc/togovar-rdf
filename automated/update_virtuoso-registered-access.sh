...
TOGOVAR_DEV_DIR=/home/rundeck/togovar-data/virtuoso-registered-access
...
docker-compose exec -T virtuoso_registered_access isql-v 1111 dba dba exec="checkpoint"
exec_3=`echo $?`
docker-compose exec -T virtuoso_registered_access isql-v 1111 dba dba -K
exec_4=`echo $?`
